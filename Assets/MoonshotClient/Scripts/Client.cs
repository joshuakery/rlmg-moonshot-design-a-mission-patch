...
public class Client : MonoBehaviour
{
    ...
    private void LoadMissionScene()
    {
        ...
        // else
        // {
        //     Debug.Log("didn't load new scene because scene 0 is already the active scene.   active scene = " + SceneManager.GetActiveScene().name + "   scene 0 = " + SceneManager.GetSceneByBuildIndex(0).name);
        // }
    }
