...
{
    join = 1,
    sendStationDataToClient,
    sendStartRoundToClient,
    sendStartMissionToClient,
    sendStopMissionToClient,
    sendPauseMissionToClient,
    sendUnPauseMissionToClient,
    sendAllStationDataToClient,
    sendEndMissionToClient,
    sendErrorToClient,
    sendResumeRoundToClient
}
...
{
    joinReceived = 1,
    sendStationDataToServer,
    sendStartMissionToServer,
